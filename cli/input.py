...
class UserInputHandler:
    ...
    def get_menu_choice(self):
        ...
        print("6. Autor anlegen")
        print("7. Autor löschen")
        print("8. Verlag anlegen")
        print("9. Verlag löschen")
        print("10. Menüeintrag anlegen")
        print("11. Menüeintrag löschen")
        print("12. Reservierung anlegen")
        print("13. Reservierung löschen")
        # ...weitere Optionen...
